(function (global, factory) {
  ...
  (factory((global.JC = global.JC || {}),global.THREE));
  ...
  function Boid() {
    ...
    var _options$position = options.position,
        position = _options$position === undefined ? new three.Vector3() : _options$position,
        _options$rotation = options.rotation,
        rotation = _options$rotation === undefined ? new three.Euler() : _options$rotation,
        _options$velocity = options.velocity,
        velocity = _options$velocity === undefined ? new three.Vector3() : _options$velocity,
  ...
  var CubeWall = function (_Wall) {
    ...
    function CubeWall(min, max) {
      ...
      _this.bounding = new three.Box3(min, max);
